...
import 'package:vizion_ai/utils/local_storage.dart';
...
class AdsController extends GetxController {
  ...
  void loadRewardedInterstitialAd(Function(RewardedInterstitialAd? interstitialAd, bool isLoad) rewardedInterstitialAdAdCallBack) {
  ...
  void loadShowAdsManagerRewarded({required Function() dismissCallBack}) {
    loadRewardedAd(
      (rewardedAd, isLoad) {
        if (isLoad) {
          rewardedAd!.show(
  ...
  void loadNative({required Function(NativeAd nativeId) callBack}) {
  ...
  void loadRewardedAd(Function(RewardedAd? rewardedAd, bool isLoad) rewardedAdCallBack) {
    adsUniqueKey = getRandomString();
    rewardedApiCall(1);
    RewardedAd.load(
  ...
  void showInterstialAd(Function() dismissEvent) {
  ...
  void loadShowAdsManagerRewardedInterstial({required Function() dismissCallBack}) {
    adsLoader(true);
  ...
  Future<void> interestialApiCall(int adStatus) async {
  ...
  Future<void> rewardedInterestialApiCall(int adStatus) async {
    Map<String, dynamic> param = {
      "userId": loginUserData.value.id,
      "adType": "6",
      "adCurrentStatus": adStatus.toString(),
  ...
  Future<void> rewardedApiCall(int adStatus) async {
    Map<String, dynamic> param = {
      "userId": loginUserData.value.id,
      "adType": "5",
      "adCurrentStatus": adStatus.toString(),
  ...
  Future<void> nativeApiCall(int adStatus) async {
    Map<String, dynamic> param = {
      "userId": loginUserData.value.id,
      "adType": "3",
      "adCurrentStatus": adStatus.toString(),
