  ...
  try {
    if (uri.toString().contains("http")) {
      ...
      if (response.statusCode == 200) {
        ...
        ShareResult shareResult = await SharePlus.instance.share(ShareParams(files: [fileToXFile(file)]));
      ...
      ShareResult shareResult = await SharePlus.instance.share(ShareParams(files: [fileToXFile(File(uri.toString()))]));
      isShareDone = shareResult.status == ShareResultStatus.success;
    }
  } catch (e) {
