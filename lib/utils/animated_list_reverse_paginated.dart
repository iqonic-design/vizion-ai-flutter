...
class AnimatedListViewReversePaginated extends StatefulWidget {
  ...
  const AnimatedListViewReversePaginated({
    super.key,
    this.controller,
    this.itemCount,
    this.padding,
  ...
  @override
  State<AnimatedListViewReversePaginated> createState() => _AnimatedListViewReversePaginatedState();
}

class _AnimatedListViewReversePaginatedState extends State<AnimatedListViewReversePaginated> {
