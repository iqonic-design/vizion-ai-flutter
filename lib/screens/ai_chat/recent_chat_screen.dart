...
class RecentChatScreen extends StatelessWidget {
  ...
  void userADConsent({required BuildContext context, required Function onAccept}) {
    showAppDialog(
      context,
      ...
      dialogText: "By tapping on the proceed button, ads will be shown to you to generate content for free.",
      titleText: "",
    );
  }
}
