...
import 'package:vizion_ai/components/app_dialog_widget.dart';
import 'package:vizion_ai/components/cached_image_widget.dart';
                  ...
                  () => artGenController.historyResponse.value.data.isEmpty
                      ...
                      : Column(
                          children: [
                            ...
                            GridView.builder(
                              itemCount: artGenController.historyResponse.value.data.where((element) => element.histroyImage.isNotEmpty).length,
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 10, mainAxisSpacing: 10),
                              itemBuilder: (context, index) {
                                HistoryElement historyElementData = artGenController.historyResponse.value.data.where((element) => element.histroyImage.isNotEmpty).toList()[index];
                                return Stack(
                                  fit: StackFit.expand,
                                  children: [
                                    Stack(
                                          ...
                                          child: Row(
                                            children: [
                                              Container(
                                                ...
                                                decoration: boxDecorationDefault(color: borderColor.withValues(alpha: 0.8), borderRadius: const BorderRadius.all(Radius.circular(16))),
