...
import 'package:vizion_ai/open_ai/models/v1_images_generation_res.dart';
import 'package:vizion_ai/screens/ai_art_generator/art_gen_controller.dart';
...
class ViewArtImg extends StatelessWidget {
  ...
  V1ImageGenerationResponse get imgGenDetail =>
      V1ImageGenerationResponse.fromJson(artGenController.selectedHistoryElement.value.historyData.responseBody is Map ? artGenController.selectedHistoryElement.value.historyData.responseBody : {});
