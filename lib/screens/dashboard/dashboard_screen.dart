...
import 'package:vizion_ai/screens/ai_chat/recent_chat_controller.dart';
              ...
              () => Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: canvasColor.withValues(alpha: 0.9),
                    borderRadius: const BorderRadius.all(Radius.circular(24)),
                    boxShadow: [
                      BoxShadow(
                        color: canvasColor.withValues(alpha: 0.3),
                        ...
                        (index) {
                          return BtmNavItem(
                            ...
                            riveOnInit: (artboard) {
                              ...
                              dashboardController.bottomNavItems[index].rive.status =
                                  RiveUtils.getRiveInput(artboard, stateMachineName: dashboardController.bottomNavItems[index].rive.stateMachineName);
                            },
