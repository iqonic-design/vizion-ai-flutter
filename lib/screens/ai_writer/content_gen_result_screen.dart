...
import 'package:vizion_ai/screens/ai_writer/content_gen_controller.dart';
        ...
        child: AppScaffold(
          ...
          body: Stack(
            children: [
              ...
              // ✅ Show Buttons only after content is ready and non-empty
              Obx(() {
                final content = contentGenController.currentContent.value.content.value;
                if (!contentGenController.isContentReady.value || content.trim().isEmpty) {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      AppButton(
                        ...
                        color: canvasColor,
                        onTap: () {
                          SharePlus.instance.share(ShareParams(text: content.replaceAll('\\n', '\n')));
                        },
                        child: TitleWithIconWidget(
