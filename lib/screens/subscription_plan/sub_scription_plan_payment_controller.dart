...
import 'package:vizion_ai/payment_gateways/flutter_wave_service.dart';
import 'package:vizion_ai/services/in_app_purchase.dart';
import 'package:vizion_ai/payment_gateways/pay_pal_service.dart';
import 'package:vizion_ai/payment_gateways/sadad_services.dart';
import 'package:vizion_ai/screens/subscription_plan/plan_confirmation_dialog.dart';
import 'package:vizion_ai/screens/subscription_plan/services/plan_services_api.dart';
import 'package:vizion_ai/screens/subscription_plan/subscription_plan_success_screen.dart';
import '../../configs.dart';
...
class SubscriptionPlanPaymentController {
  ...
  void handlePayNowClick(BuildContext context, {Package? selectedRevenueCatPlan}) {
  ...
  Future<void> payWithInAppPurchase(BuildContext context, Package? selectedRevenueCatPlan) async {
