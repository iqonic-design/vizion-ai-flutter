...
import 'package:vizion_ai/components/app_scaffold.dart';
import 'package:vizion_ai/screens/subscription_plan/sub_scription_plan_payment_controller.dart';
import 'package:vizion_ai/screens/subscription_plan/sub_scription_plan_payment_screen.dart';
import 'package:vizion_ai/utils/auto_scroll_widget.dart';
                              ...
                              child: GroupButton<SubscriptionModel>(
                                ...
                                buttonBuilder: (selected, value, context) {
                                  ...
                                  if (isInAppPurchaseEnable.value && value.identifier != FREE) {
                                    revenueCatProduct = homeController.revenueCatOfferings?.current!.availablePackages
                                        .firstWhere((element) => element.storeProduct.identifier == (isIOS ? value.appStoreIdentifier : value.playStoreIdentifier))
                                        .storeProduct;
                                  }
                      ...
                      Obx(
                        () {
                          return AppButton(
                            ...
                            disabledColor: fullDarkCanvasColor.withValues(alpha: 0.4),
                            onTap: () async {
                          ...
                          ).paddingOnly(left: 16, right: 16, bottom: 16).visible(homeController.selectedPlan.value.identifier != FREE &&
                              homeController.dashboardData.value.subscriptionPlan.isNotEmpty &&
                              homeController.selectedPlan.value.identifier != userCurrentSubscription.value.identifier);
                        },
                      ),
                    ],
                  ),
