...
import 'package:vizion_ai/screens/ai_voice_to_text/v2t_gen_controller.dart';
              ...
              child: Row(
                ...
                children: [
                  ...
                  AppButton(
                    ...
                    color: canvasColor,
                    onTap: () {
                      SharePlus.instance.share(ShareParams(text: v2TController.currentContent.value.content.value.replaceAll('\\n', '\n')));
                    },
                    child: TitleWithIconWidget(
