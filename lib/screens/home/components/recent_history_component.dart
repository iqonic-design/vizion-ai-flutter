                    ...
                    () => Row(
                      ...
                      children: List.generate(
                        ...
                        (index) => AnimatedContainer(
                          ...
                          decoration: boxDecorationWithRoundedCorners(backgroundColor: homeController.currentHistoryPage.value == index ? appColorPrimary : appColorPrimary.withValues(alpha: 0.5)),
                        ).paddingAll(2),
                      ),
                    ).center(),
                  ),
