        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              10.height,
              CachedImageWidget(
                url: Assets.imagesAuthResetPassword,
                fit: BoxFit.cover,
                height: 230,
              ),
              10.height,
              AppTextField(
                ...
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return "This field is required"; // Localize if needed
                  }
                  return null;
                },
              ),
              ...
              AppTextField(
                ...
                suffixPasswordInvisibleWidget: commonLeadingWid(imgPath: Assets.iconsIcEyeSlash, color: borderColor).paddingAll(12),
                validator: (value) {
                  if (value.validate().length >= 8 && value.validate().length <= 12) {
                    return null;
                  } else {
                    return locale.value.passwordShouldBe8To12CharactersLong;
                  }
                },
              ),
              16.height,
