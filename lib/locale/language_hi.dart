...
class LanguageHi extends BaseLanguage {
  ...
  @override
  String get paymentMsgErr => 'आपने भुगतान प्रक्रिया रद्द कर दी है';

  @override
  String get inAppUpdate => 'ऐप अपडेट में';

  @override
  String get waitForAWhile => 'थोड़ी देर प्रतीक्षा करें, हम आपकी सदस्यता अपडेट कर रहे हैं';
  ...
  @override
  String get pleaseSelectProgrammingLanguage => 'कृपया प्रोग्रामिंग भाषा चुनें';

  @override
  String get passwordShouldBe8To12CharactersLong => 'पासवर्ड 8 से 12 अक्षरों का होना चाहिए';
  ...
  @override
  String get pleaseEnterPrompt => 'कृपया संकेत दर्ज करें';

  @override
  String get noSearchFound => 'कोई खोज नहीं मिली';
}