...
@section('content')
        ...
        <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control form-control-sm dt-search" placeholder="{{ __('messages.search')}}.." aria-label="Search"
    ...
    <div data-render="app">
        ...
        <plan-offcanvas create-title="{{ __('Create') }} {{ __($module_title) }}"
            ...
            :is-in-app-purchase-enable="{{ $is_in_app_purchase_enable }}" >
        </plan-offcanvas>
