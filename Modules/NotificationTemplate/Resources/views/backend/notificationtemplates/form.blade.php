<div class="row">
  ...
  <div class="row">
      <div class="col-md-12 pt-2">
          <button type="submit" class="btn btn-primary">{{ (__('save'))}} <i class="far fa-save"></i> <i class="md md-lock-open"></i></button>
          <button onclick="window.history.back();"  class="btn btn-outline-primary" ><i class="fa-solid "></i> {{ (__('Cancel'))}}<i class="md md-lock-open"></i></button>
      </div>
  </div>
</div>
<script>
