          ...
          <div class="col-md-12 row">
            <div class="col-md-12 text-center">
              ...
              <div class="d-flex align-items-center justify-content-center gap-2">
                ...
                <label class="btn btn-primary-subtle mb-3" for="logo">Upload</label>
                <input type="button" class="btn btn-danger-subtle mb-3" name="remove" value="Remove" @click="removeLogo()" v-if="ImageViewer" />
              </div>
              <span class="text-danger">{{ errors.profile_image }}</span>
            </div>

            <InputField :is-required="true" :label="$t('customer.lbl_first_name')" :placeholder="$t('placeholder.first_name')" v-model="first_name" :error-message="errors.first_name" :error-messages="errorMessages['first_name']"></InputField>
            <InputField :is-required="true" :label="$t('customer.lbl_last_name')" :placeholder="$t('placeholder.last_name')" v-model="last_name" :error-message="errors['last_name']" :error-messages="errorMessages['last_name']"></InputField>

            <InputField :is-required="true" :label="$t('customer.lbl_Email')" :placeholder="$t('placeholder.email')" v-model="email" :error-message="errors['email']" :error-messages="errorMessages['email']"></InputField>
            ...
            <div class="row" v-if="currentId === 0">
              ...
              :placeholder="$t('placeholder.login_password')" v-model="password" :error-message="errors['password']"
              ...
              :placeholder="$t('placeholder.login_password')" v-model="confirm_password" :error-message="errors['confirm_password']"
