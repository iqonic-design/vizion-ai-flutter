      ...
      <div class="offcanvas offcanvas-end offcanvas-booking" id="user_send_push_notification" aria-labelledby="form-offcanvasLabel">
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <InputField type="text" class="col-md-12" :is-required="true" :label="$t('customer.lbl_title')"
                  placeholder="" v-model="title" :error-message="errors['title']"
                  :error-messages="errorMessages['title']"></InputField>
  
                  <div class="form-group col-md-12">
                    <label class="form-label" for="description">{{ $t('customer.lbl_description') }} <span class="text-danger">*</span></label>
        ...
        <div class="offcanvas-footer border-top">
            <div class="d-grid d-md-flex gap-3 p-3">
              ...
              <button class="btn btn-primary-subtle d-flex align-items-center gap-1" type="button" data-bs-dismiss="offcanvas">
                Cancel
