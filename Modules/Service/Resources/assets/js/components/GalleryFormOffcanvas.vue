    ...
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="service-gallery-form" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-footer border-top">
        <div class="d-grid d-md-flex justify-content-end gap-3">
          <button class="btn btn-primary-subtle" type="button" data-bs-dismiss="offcanvas">{{$t('service.lbl_close')}}<i class="icon-Arrow---Right-2"></i></button>
          <button class="btn btn-primary d-flex align-items-center gap-1">{{$t('service.lbl_update')}}<i class="ph ph-floppy-disk"></i></button>
        </div>
      </div>
    </div>
  </form>
