<div class="text-end">
    ...
    <a href="{{route('backend.users.edit', $data)}}" class="btn btn-primary btn-icon btn-sm" data-bs-toggle="tooltip" data-bs-title="{{__('labels.backend.edit')}}"><i class="ph ph-pencil-simple"></i></a>
    <a href="{{route('backend.users.changePassword', $data)}}" class="btn btn-info btn-icon btn-sm" data-bs-toggle="tooltip" data-bs-title="{{__('labels.backend.changePassword')}}"><i class="ph ph-lock-key"></i></a>
